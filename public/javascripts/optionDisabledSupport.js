...
var OptionDisabledSupport = new function() {
  ...
  this.init = function() {
    ...
    for (var i=0;i<selects.length;i++) {
      ...
      select.attachEvent ('onclick',oldOnClick)
      select.attachEvent ('onchange',oldOnChange)
...
if (window.attachEvent) window.attachEvent('onload', OptionDisabledSupport.init);